						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" href="http://www.light.com/index.php?r=pay/pay">立即购买</a>
								</div>
							</li>
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="http://www.light.com/index.php?r=shopcart/shopcart"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
